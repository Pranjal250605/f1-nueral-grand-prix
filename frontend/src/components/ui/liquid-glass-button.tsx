...
// ─────────────────────────────────────────────────────────────────────────────
// Liquid Glass Button — SVG turbulence distortion over backdrop
// ─────────────────────────────────────────────────────────────────────────────
...
function LiquidButton({
  ...
  return (
    <Comp
      ...
      {...props}
    >
      {/* Physical glass edge — complex inset shadow stack */}
      ...
      {/* Turbulence distortion layer — picks up whatever is behind it */}
      <div
...
// ─────────────────────────────────────────────────────────────────────────────
// Metal Button — tactile pressed-metal feel with gradient layers
// ─────────────────────────────────────────────────────────────────────────────
...
const colorVariants: Record<ColorVariant, {
  ...
  primary: {
    outer:      "bg-gradient-to-b from-[#000] to-[#A0A0A0]",
    inner:      "bg-gradient-to-b from-[#f5c518] via-[#c49a0e] to-[#f5c518]",
    button:     "bg-gradient-to-b from-[#f5c518] to-[#c49a0e]",
